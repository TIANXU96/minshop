<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"C:\wamp64\www\work\minshop\public/../application/admin\view\login\find.html";i:1559272402;s:74:"C:\wamp64\www\work\minshop\application\admin\view\public\footerJsFile.html";i:1553913178;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <!--引入头文件-->
    ...
    <div class="am-g">
        <div class="am-g">
            <div class="am-u-sm-10 am-u-md-8 am-u-lg-4 am-u-sm-centered">
                ...
                <span class="am-center am-text-center am-text-xl">用户重置密码</span>
            </div>
        </div>
        <!--login-->
                ...
                <div class="am-radius back-color-w">
                    <form action="" class="am-form" method="post" >
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <span><a href="<?php echo url('admin/login/login'); ?>" class="am-link-muted am-text-sm">登陆</a></span>
                            </div>
...
<script type="text/javascript">
    $(function () {
        $("#get_verify").click(function () {
            ...
            $.ajax({
                url: '<?php echo url("admin/Login/sendEmail"); ?>',
                data: {
...
<script>
    $(function () {
        $("#ajax_find_password").click(function () {
            ...
            $.ajax({
                url: '<?php echo url("admin/Login/ajax_jump_find"); ?>',
                data: {
                    'admin_email': admin_email,
                    'admin_name': admin_name,
                ...
                success: function (result) {
                    ...
                    switch (arr[0]) {
                        ...
                        case 'wrong_admin_name':
                            ...
                            break;
                        case 'pass':
                            window.location.replace("<?php echo url('admin/login/change'); ?>");
                            break;
                        default:
                            //nothing
                            break;
