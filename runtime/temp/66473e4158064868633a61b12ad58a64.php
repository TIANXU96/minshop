<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"C:\wamp64\www\work\minshop\public/../application/admin\view\login\login.html";i:1559272350;s:74:"C:\wamp64\www\work\minshop\application\admin\view\public\footerJsFile.html";i:1553913178;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <!--引入头文件-->
    ...
    <div class="am-g">
        <div class="am-g">
            <div class="am-u-sm-10 am-u-md-8 am-u-lg-4 am-u-sm-centered">
                ...
                <span class="am-center am-text-center am-text-xl">登陆</span>
            </div>
        </div>
        <!--login-->
                ...
                <div class="am-radius back-color-w">
                    <form action="" class="am-form" method="post">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <span><a href="<?php echo url('admin/login/find'); ?>" class="am-link-muted am-text-sm">忘记密码？</a></span>
                            </div>
                        </fieldset>
                    </form>
                </div>
                ...
                success: function (result) {
                    switch (result['id']) {
                        ...
                        case  2:
                            ...
                            break;
                        case  3:
                            window.location.replace("<?php echo url('admin/home/index'); ?>");
                            //jump
                            break;
                        case  4:
                            $("#login_info").attr("class", "am-text-danger am-icon-info-circle").html(result['mes']);
