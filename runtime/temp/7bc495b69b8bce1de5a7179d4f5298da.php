<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"C:\wamp64\www\work\minshop\public/../application/admin\view\login\change.html";i:1559099991;s:74:"C:\wamp64\www\work\minshop\application\admin\view\public\footerJsFile.html";i:1553913178;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <!--引入头文件-->
                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group am-block">
                                ...
                                <input type="text" id="admin_name" minlength="6"
                                       placeholder="输入需要重置的用户名6-12位" required/>
                            </div>
                            <div class="am-form-group am-block">
...
<script type="text/javascript">
    $(function () {
        $("#change_password").click(function () {
            ...
            $.ajax({
                url: '<?php echo url("admin/Login/ajax_change"); ?>',
                data: {
                ...
                success: function (result) {
                    ...
                    switch (arr[0]) {
                        ...
                        case 'pass':
                            alert(result[arr[0]]);
                            window.location.replace("<?php echo url('admin/login/login'); ?>");
                            break;
                        default:
                            break;
                    }
