<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:89:"C:\wamp64\www\work\minshop\public/../application/index\view\shopclassification\index.html";i:1558351100;s:72:"C:\wamp64\www\work\minshop\application\index\view\public\headerFile.html";i:1553500178;s:66:"C:\wamp64\www\work\minshop\application\index\view\public\head.html";i:1558066973;s:69:"C:\wamp64\www\work\minshop\application\index\view\public\sidebar.html";i:1558351136;s:74:"C:\wamp64\www\work\minshop\application\index\view\public\footerJsFile.html";i:1553913178;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <!--引入头文件-->
        ...
        <ul class="am-list admin-sidebar-list">
            ...
            <li>
                ...
                <ul class="am-list am-collapse admin-sidebar-sub" id="shop-nav">
                    <li><a href="<?php echo url('index/shopmanagement/index'); ?>" class="am-cf">商品管理</a></li>
                    <li><a href="<?php echo url('index/shopclassification/index'); ?>" class="am-cf">商品分类</a></li>
                </ul>
            </li>
            <li>
    ...
    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户管理{classification}</strong> /
                    <small>用户列表{}</small>
                </div>
            </div>
            <hr>
